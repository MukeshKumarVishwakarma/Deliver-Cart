    ...
    return (
        <div className='flex flex-col items-center justify-center min-h-screen px-6 py-10 bg-white relative'>
            <motion.h1
                ...
                <p className='text-gray-600 mb-8 flex items-center'>Login Servicecart<Leaf className='w-5 h-5 text-green-600' /> </p>
                <motion.form
                ...
                className='flex flex-col gap-5 w-full max-w-sm'>
                    ...
                    <div className='relative'>
                        ...
                        <input type='text' placeholder='Enter Your Email' className='w-full border border-gray-300 rounded-xl py-3 pl-10 pr-4 text-gray-800 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500'
                        onChange={(e) => setEmail(e.target.value)} value={email}/>
                        </div>
                        <div className='relative'>
                            <Lock className='absolute left-3 top-3.5 w-5 h-5 text-gray-400' />
                            <input type={showPassword ? "text" : "password"} placeholder='Enter Your Password' className='w-full border border-gray-300 rounded-xl py-3 pl-10 pr-4 text-gray-800 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-green-500'
                        ...
                        <div className='flex items-center gap-2 text-gray-400 text-sm mt-2'>
                            <span className='flex-1 h-px bh-gray-200'></span>
                            OR
                            <span className='flex-1 h-px bh-gray-200'></span>
                        </div>
            ...
            <LogIn className='w-4 h-4' /><span className='text-green-600'>Sign Up</span>
            </p>
        </div>
    )
}
